...
public class Modal {
    ...
    SQLiteDatabase bd = null; Dto datos = new Dto();
    ...
    public void Search(final Context context){
        ...
        final base conexion = new base(context);
            final EditText et_cod = (EditText)myDialog.findViewById(R.id.txtcodigo);
            Button btn_buscar = (Button)myDialog.findViewById(R.id.btn_buscar);
            TextView tv_close = (TextView)myDialog.findViewById(R.id.txt);
            ...
            public void onClick(View view) {
                ...
                if(validalnput) {
                    ...
                    if (conexion.consultaCodigo(datos)) {
                        codigo = String.valueOf(datos.getCode());
                        descripcion = datos.getDes();
